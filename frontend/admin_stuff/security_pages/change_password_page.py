...
def change_password(current_password, new_password, confirm_new_password):
    ...
    response = session.post("http://localhost:8000/api/users/update-password", json={"current_password": current_password, "new_password": new_password}, headers={"Authorization": f"Bearer {token}"})
